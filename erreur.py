...
api_key = "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"  
if not api_key:
    raise ValueError("⚠️ Clé API OpenAI non définie ! Ajoute ta clé dans les variables d'environnement.")

# 🔹 Initialisation de l'API OpenAI
openai.api_key = api_key   # ✅ Version correcte du client
